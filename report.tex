...
\begin{itemize}
    ...
    \item The third approximation experiment showed that the algorithms perform at consistent rates as the size of the graphs (nodes and proprtional edges) increase
