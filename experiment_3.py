...
from graph import create_random_graph, MVC, approx2, approx3
...
plot.plot([x + 2 for x in range(runs)], mvc_sums, label="Minimum Vertex Cover")
# plot.plot([2 * (x + 1) for x in range(10)], approx1_sums, label="Approximation 1")
plot.plot([x + 2 for x in range(runs)], approx2_sums, label="Approximation 2")
plot.plot([x + 2 for x in range(runs)], approx3_sums, label="Approximation 3")
